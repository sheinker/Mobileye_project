...
def coord_to_crop(image_label: np.array, image: np.array, x_coord: list, y_coord: list, first: int, last: int,
                  labels, data) -> None:
...
def correct_data(data_file, index: int) -> None:
...
def get_coord(image: np.ndarray):
